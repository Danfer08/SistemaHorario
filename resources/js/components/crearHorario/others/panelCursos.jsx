    ...
    <div className="lg:col-span-1">
      <div className="bg-white rounded-xl shadow-md p-6 sticky top-6">
        <div className="flex items-center justify-between mb-4">
          <h3 className="text-lg font-semibold text-gray-800">Cursos Pendientes</h3>
          <button
            onClick={toggleIrregulares}
            className={`text-xs px-2 py-1 rounded border transition ${showIrregulares
              ? 'bg-purple-100 text-purple-700 border-purple-300'
              : 'bg-gray-50 text-gray-600 border-gray-200 hover:bg-gray-100'
              }`}
          >
            {showIrregulares ? 'Ocultar Irregulares' : 'Ver Irregulares'}
          </button>
        </div>
                ...
                <div className="flex items-center justify-between">
                  <div className="flex-1">
                    ...
                    <div className="flex items-center gap-2 mt-1 flex-wrap">
                      ...
                      <span className={`text-xs px-2 py-1 rounded ${curso.tipo_curso === 'obligatorio'
